KNOWN_MERCHANT_CATEGORIES = {
    ...
    "transport": ["bkk", "mav", "taxi", "bolt.eu"],
    "fuel": ["mol", "shell", "omv"],
    "bills": ["mvm", "nkm", "dmrv", "telekom", "digi", "vodafone", "telenor"],
    "shopping": ["alza", "amazon", "aliexpress", "decathlon", "obi", "c&a"],
    "renovation": ["bauhaus", "praktiker", "obi", "ikea"],
}
...
SEED_DATA = [
    ...
    ("Temu", "shopping", -8000.0),
    ("Decathlon", "shopping", -8000.0),
    ("Ikea", "furniture", -8000.0),
    ("Obi", "renovation", -8000.0),
